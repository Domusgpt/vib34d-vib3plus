...
- All three flagship visual systems—Faceted, Quantum, and Holographic—expose a triad of `rot4dXW`, `rot4dYW`, and `rot4dZW` controls that directly influence their internal shaders via the runtime parameter bridge. These parameters default to zero at initialization but are continuously adjustable through the `updateParameter` interface that every system shares.【F:systems/faceted/FacetedSystem.js†L221-L312】【F:systems/quantum/QuantumSystem.js†L248-L322】【F:systems/holographic/HolographicSystem.js†L271-L364】
